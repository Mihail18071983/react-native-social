...
## Usage 
 ...
 To the Posts screen you can move by clicking icon (./assets/images/icon1.png). In this screen you can watch all users posts. You can add comment to the any post by clicking (./assets/images/Shape.png). Then you will be redirected to the comment screen where you could add comment. For returning to the posts screen you need clicking by (./assets/images/arrow-left.png)
 For logging out you need clicking by (./assets/images/log-out.png)